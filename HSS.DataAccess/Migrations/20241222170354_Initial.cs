            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Name = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    ChemicalFormula = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    ...
                    AlternativeNames = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
